                            ...
                            <li>
                                <details class="mb-2">
                                    ...
                                    <div class="ml-4 mt-2">
                                        ...
                                        <ul class="list-disc ml-5">
                                            <li><strong>Lagu: Let It Be (The Beatles)</strong>  
                                                <br>Progressi chord: C - G - Am - F  
                                                <br>Pola: Down - Down - Down - Down
                                            </li>
                                            <li class="mt-2"><strong>Lagu: Perfect (Ed Sheeran)</strong>  
                                                <br>Progressi chord: G - Em - C - D  
                                                <br>Pola: Down - Down - Up - Up - Down - Up
                                            </li>
                                            <li class="mt-2"><strong>Lagu: Cinta Luar Biasa (Andmesh)</strong>  
                                                <br>Progressi chord: C - G - Am - F  
                                                <br>Pola: Down - Up - Down - Up
                                            </li>
                                        </ul>
